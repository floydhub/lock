...
describe('LastLoginScreen', function() {
  ...
  it('renders correctly', function() {
    ...
    (0, _testUtils.expectComponent)(
      _react2.default.createElement(Component, defaultProps)
    ).toMatchSnapshot();
  });
  ...
  describe('renders correct icon', function() {
    ...
    require('connection/social/index').STRATEGIES = ((_require$STRATEGIES = {}),
    (_require$STRATEGIES[testStrategyName] = 'Test Strategy'),
    _require$STRATEGIES);
    var strategies = [
      testStrategyName,
      'google-apps',
  ...
  it('calls logIn in the buttonClickHandler', function() {
    var Component = getComponent();
