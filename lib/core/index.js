...
function extractUIOptions(id, options) {
  var closable = options.container
    ? false
  ...
  return new _immutable2.default.fromJS({
    ...
    autofocus:
      undefined === options.autofocus
        ? !(options.container || (0, _media_utils.isSmallScreen)())
        : !!options.autofocus,
    avatar: avatar,
    ...
    language:
      undefined === options.language
        ? 'en'
        : (0, _trim2.default)(options.language || '').toLowerCase(),
    ...
    authButtonsTheme:
      (typeof authButtons === 'undefined' ? 'undefined' : _typeof(authButtons)) === 'object'
        ? authButtons
        : {},
...
function extractAuthOptions(options) {
  ...
  connectionScopes =
    (typeof connectionScopes === 'undefined' ? 'undefined' : _typeof(connectionScopes)) === 'object'
      ? connectionScopes
      : {};
  params =
...
function connections(m) {
  ...
  if (arguments.length === 1) {
    return tget(m, 'connections', (0, _immutable.Map)())
      .filter(function(v, k) {
        return k !== 'unknown';
      })
      .valueSeq()
...
function connection(m) {
  ...
  for (
    var _len2 = arguments.length, strategies = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2;
    _key2 < _len2;
    _key2++
  ) {
...
function hasOnlyConnections(m) {
  ...
  for (
    var _len3 = arguments.length, strategies = Array(_len3 > 2 ? _len3 - 2 : 0), _key3 = 2;
    _key3 < _len3;
    _key3++
  ) {
...
function hasSomeConnections(m) {
  ...
  for (
    var _len4 = arguments.length, strategies = Array(_len4 > 2 ? _len4 - 2 : 0), _key4 = 2;
    _key4 < _len4;
    _key4++
  ) {
...
function countConnections(m) {
  ...
  for (
    var _len5 = arguments.length, strategies = Array(_len5 > 2 ? _len5 - 2 : 0), _key5 = 2;
    _key5 < _len5;
    _key5++
  ) {
...
function filterConnections(m) {
  ...
  return tset(
    m,
    'connections',
    (0, _index2.clientConnections)(m).map(function(cs) {
      return cs
        .filter(function(c) {
          return order(c) >= 0;
        })
...
function runHook(m, str) {
  for (
    var _len6 = arguments.length, args = Array(_len6 > 2 ? _len6 - 2 : 0), _key6 = 2;
    _key6 < _len6;
    _key6++
  ) {
...
function emitEvent(m, str) {
  for (
    var _len7 = arguments.length, args = Array(_len7 > 2 ? _len7 - 2 : 0), _key7 = 2;
    _key7 < _len7;
    _key7++
  ) {
