...
function shouldRenderTabs(m) {
  ...
  if (l.hasSomeConnections(m, 'social') && (0, _index.hasInitialScreen)(m, 'signUp'))
    return (0, _index.hasScreen)(m, 'signUp');
}
...
var Component = function Component(_ref) {
  ...
  var tabs =
    ...
    _react2.default.createElement(_login_sign_up_tabs2.default, {
      key: 'loginsignup',
      lock: model,
  ...
  var showPassword =
    ...
    (l.hasSomeConnections(model, 'database') ||
      !!(0, _enterprise.findADConnectionWithoutDomain)(model));

  var showForgotPasswordLink = showPassword && l.hasSomeConnections(model, 'database');

  var loginInstructionsKey = social
    ? 'databaseEnterpriseAlternativeLoginInstructions'
    : 'databaseEnterpriseLoginInstructions';

  var usernameInputPlaceholderKey =
    (0, _index.databaseUsernameStyle)(model) === 'any' ||
  ...
  var login =
    ...
    _react2.default.createElement(_login_pane2.default, {
  ...
  var ssoNotice =
    sso &&
    _react2.default.createElement(_single_sign_on_notice2.default, null, i18n.str('ssoEnabled'));

  var separator = social && login && _react2.default.createElement(_pane_separator2.default, null);

  return _react2.default.createElement('div', null, ssoNotice, tabs, social, separator, login);
};
...
var Login = (function(_Screen) {
  ...
  Login.prototype.submitHandler = function submitHandler(model) {
    ...
    if (
      (0, _enterprise.isHRDDomain)(model, (0, _index.databaseUsernameValue)(model)) &&
      !l.oidcConformant(model)
    ) {
      return function(id) {
    ...
    var useDatabaseConnection =
      !(0, _classic.isSSOEnabled)(model) &&
      (0, _index.databaseConnection)(model) &&
      ((0, _index.defaultDatabaseConnection)(model) ||
        !(0, _enterprise.defaultEnterpriseConnection)(model));
